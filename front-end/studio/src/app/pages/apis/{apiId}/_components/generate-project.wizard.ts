...
import {DeploymentOption,DeploymentOptionValue as DeploymentOptionValue} from "../../../../components/common/deployment-options.component";
import {MonitoringOption,MonitoringOptionValue as MonitoringOptionValue} from "../../../../components/common/monitoring-options.component";
...
var DEPLOY_OPTIONS: DeploymentOption[] = [
    new DeploymentOptionValue("azure-pipeline-dev", "azure-dev", true),
    new DeploymentOptionValue("azure-pipeline-qa", "azure-qa", false),
    new DeploymentOptionValue("azure-pipeline-preprod", "azure-pre", false),
    new DeploymentOptionValue("azure-pipeline-prod", "azure-prod", false),
];
    ...
    public goBack(): void {
        switch (this.currentPage) {
           ...
           /* case "domainType":
                ...
                break;
            case "commonServices":
                this.currentPage = "domainType";
                break;*/
            case "deployment":
                this.currentPage = "templateType";
                break;
           /* case "monitoring":
                this.currentPage = "deployment";
                break;*/
           case "location":
                this.currentPage = "deployment";
                break;
    ...
    public goNext(): void {
        switch (this.currentPage) {
            ...
            case "templateType":
                ...
                break;
          /*  case "domainType":
                this.currentPage = "commonServices";
                break;
            case "commonServices":
                this.currentPage = "deployment";
                break;*/
