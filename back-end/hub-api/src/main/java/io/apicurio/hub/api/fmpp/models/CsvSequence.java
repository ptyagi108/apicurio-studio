...
public class CsvSequence implements
    ...
    public void load(Reader in)
            throws StringUtil.ParseException, IOException {
        if (loaded) {
    ...
    private class Parser {
        ...
        private void load()
                throws IOException, StringUtil.ParseException {
            String s;
            boolean hasNextCol;
                            ...
                            if (s.length() != 0) {
                                if (dateFormat != null) {
                                    try {
                                        ...
                                        throw new StringUtil.ParseException("Date value "
                                                + StringUtil.jQuote(s)
                            ...
                            if (s.length() != 0) {
                                if (timeFormat != null) {
                                    try {
                                        ...
                                        throw new StringUtil.ParseException("Time value "
                                                + StringUtil.jQuote(s)
                                                + " is not valid according to "
                                                + "pattern "
                                                + StringUtil.jQuote(
        ...
        private void load_processHeaderCell(String s, List headerTypes)
            ...
            if (i == -1) {
                ...
                if (s2.equals("n") || s2.equals("number")) {
                    ...
                    throw new StringUtil.ParseException("Unknown data type in a "
        ...
        private String fetchValue() throws IOException, StringUtil.ParseException {
            ...
            if (cur == '"') {
                ...
                throw new StringUtil.ParseException("Reached the end of the file, and "
