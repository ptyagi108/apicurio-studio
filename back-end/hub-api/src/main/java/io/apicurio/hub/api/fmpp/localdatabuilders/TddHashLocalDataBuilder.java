...
import io.apicurio.hub.api.fmpp.DataModelBuildingException;
import io.apicurio.hub.api.fmpp.Engine;
import io.apicurio.hub.api.fmpp.LocalDataBuilder;
import io.apicurio.hub.api.fmpp.tdd.DataLoaderEvaluationEnvironment;
import io.apicurio.hub.api.fmpp.tdd.EvaluationEnvironment;
import io.apicurio.hub.api.fmpp.tdd.Fragment;
import io.apicurio.hub.api.fmpp.tdd.Interpreter;

import java.util.Map;

/**
 * Builds data from a TDD hash, interpreting function calls as data loader
 * invocations. The hash is evaluated when {@link LocalDataBuilder#build}
 * is invoked first. Then the result is stored until the end of the processing
 * session, to be reused for all subsequent {@link LocalDataBuilder#build}
 * invokations.
 * 
