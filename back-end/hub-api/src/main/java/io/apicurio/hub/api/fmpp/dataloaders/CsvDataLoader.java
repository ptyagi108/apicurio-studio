...
package io.apicurio.hub.api.fmpp.dataloaders;

import freemarker.template.TemplateModelException;
import io.apicurio.hub.api.fmpp.models.CsvSequence;
import io.apicurio.hub.api.fmpp.util.DataLoaderUtil;
 ...
 * {@link CsvSequence CsvSequence} constructors.
 *
 * <p>Note: This class should be an
 * {@link AbstractTextDataLoader} subclass, but it is not that
 * for backward compatibility.
 */
public class CsvDataLoader extends FileDataLoader {

    protected Object load(InputStream data) throws IOException,
            TemplateModelException, StringUtil.ParseException {
