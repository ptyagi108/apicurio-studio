...
import io.apicurio.hub.api.fmpp.models.*;
import io.apicurio.hub.api.fmpp.tdd.DataLoader;
import io.apicurio.hub.api.fmpp.tdd.EvalException;
import io.apicurio.hub.api.fmpp.tdd.TddUtil;
import io.apicurio.hub.api.fmpp.util.FileUtil;
import io.apicurio.hub.api.fmpp.util.FreemarkerUtil;
...
public class TemplateEnvironment {
     ...
     * example, in a {@link TemplateTransformModel} that is
    ...
    private class LoadDataMethod
        ...
        public Object exec(List args)
            ...
            DataLoader dl;
            try {
                dl = TddUtil.getDataLoaderInstance(eng, dlName);
