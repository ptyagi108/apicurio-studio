...
abstract class FmppOutputWriter extends Writer {
    ...
    abstract void setDst(File dst);

    abstract void initOutputBufferAndWriter();

    abstract ByteArrayOutputStream getBaosClone();

     abstract ZipOutputStream getZipFileWriter();
